...
#
### This GitHub respiratory contains the overall prototype code design developed throughout the "UCT SHARC Buoy: Snow Depth Sensor (SDS) System Design" project.<br /> <br /> The code can be found under the folder "Final_SnowDepthSensor", file named "Final_SnowDepthSensor.ino". 
#
