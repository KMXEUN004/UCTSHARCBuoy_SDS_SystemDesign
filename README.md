...
The code design contains libraries which need to be downloaded in order to use the code design. The following libraries and the associated links are listed below:
